...
- Preserve existing explicit host confirmation/fallback opt-ins: conservative provider aggregation does not remove `confirmationDefault: "approve"` or interactive confirmation, and neither can override an explicit denial.
